                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center"><button class="btn btn-info" onclick="window.location.href='territory_sales_admin.php?id=<?php echo $row['territory_id'] ;?>'">Record</button></td>
                              
                              
                              <td class="text-center"><button class="btn btn-success" onclick="window.location.href='update_territory.php?id=<?php echo $row['territory_id'] ;?>'">Update</button>  <button class="btn btn-danger" id="<?php echo 'delete_'.$row['territory_id'] ;?>'">Delete</button></td>
