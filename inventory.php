                        ...
                        <table class="table">
                          <thead class="thead-dark">
                            <tr >
                              ...
                              <th  class="text-center" scope="col">COG</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center"><?php echo $row['product_cog']; ?>tk</td>
                              ...
                              <td class="text-center"><button class="btn btn-info" onclick="window.location.href='product_sales.php?id=<?php echo $row['product_id'] ;?>'">Record</button></td>
                              <td class="text-center"><button class="btn btn-success" onclick="window.location.href='update_product.php?id=<?php echo $row['product_id'] ;?>'">Update</button>  <button class="btn btn-danger" id="<?php echo 'delete_'.$row['product_id'] ;?>">Delete</button></td>
            ...
            $("button").on("click",function(e){
              ...
              if (typeof(value) != "undefined")
              {
                ...
                if (value[0]==="delete")
                {
                 ...
                 {
                  window.location.href="delete_product.php?id="+value[1];
                 }
